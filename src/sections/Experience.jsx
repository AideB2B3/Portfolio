const experience = [
    {
        period: "2022 - Present", 
        role: "Ruolo Esempio", 
        company: "Compania Esempio",  
        description: "descrizione del ruolo ricoperto all'iterno dell'azienda", 
        technologies: ["Exp1","Exp2"], 
        current: true, 
    },
    {
        period: "2018 - 2020", 
        role: "Ruolo Esempio1",
        company: "Compania Esempio 1", 
        description: "descrizione del ruolo ricoperto all'iterno dell'azienda", 
        technologies: ["Exp1","Exp2"], 
        current: false, 
    },
    {
        period: "2010 - 2018", 
        role: "Ruolo Esempio 2",
        company: "Compania Esempio 2", 
        description: "descrizione del ruolo ricoperto all'iterno dell'azienda", 
        technologies: ["Exp1","Exp2"], 
        current: false, 
    },
    {
        period: "2001 - 2009", 
        role: "Ruolo Esempio 3",
        company: "Compania Esempio 3", 
        description: "descrizione del ruolo ricoperto all'iterno dell'azienda", 
        technologies: ["Exp1","Exp2"], 
        current: false, 
    },
