                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className=" text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-800">
                                Hi, I'm Davide Bellobuono - a student of automation engineering and 
                                a student in the Apple Developer Academy program at Federico II University, 
                                with excellent skills in system development, automation, and iOS application development.
                            </p>
                        </div>
                    ...
                    <div className="relative animate-fade-in animation-delay-300">
                        ...
                        <div className="relative max-w-md mx-auto">
                           ...
                           <img alt="Davide Bellobuono" class="w-full aspect-[4/5] object-cover rounded-2xl" src="profile-photo.jpeg" />
